...
public:  
 ...
 ~HadPlots();
  ...
  TGraphErrors * nch_w[kMaxFiles];             ///< average charged hadon multiplicity, <nch>, vs W^2 (p. 1, 13) // DONE

  TGraph *       D_nneg[kMaxFiles];            ///< negative hadron dispersion D- vs average multiplicity <n-> (p. 2, 14) // DONE
  TGraph *       D_W2[kMaxFiles];              ///< charged hadron dispersion over average multiplicity, D/<nch>, vs W^2 (p. 2) // DONE
